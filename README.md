...
Você pode baixar este projeto como .zip, abra a pasta GeradorDeClientes no VS Code. Com o projeto aberto no VS Code, abra o arquivo Program.cs e pressione F5.
